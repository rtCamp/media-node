...
exports.updatejob = function(job_id, field_name, field_value) {
...
function rtAddJobByURL(job, callback) {
        ...
        if (!fs.existsSync(filepath)) {
            ...
            // request(job.input_file_url, function(error, response, body) {
            //     if (!error && response.statusCode == 200) {
            //         file.write(body)
            //         file.end()
            //         console.log('Downloaded ' + filepath)
            ...
            //             callback_url: job.callback_url,
            //         },callback);
            //         console.log("END: Add job by URL called for Job # " + job.id)
            //     } else {
            //         console.log(error)
            //     }
            // }) //end of request
